...
export default function SignUp()
{
    ...
    return (
      ...
      >
        {/*-- left side --*/}
        <div className="bg-no-repeat flex flex-col justify-center p-8 rounded-t-2xl md:p-14 md:rounded-l-2xl md:rounded-tl-2xl" style={{backgroundImage:`linear-gradient(rgba(255,255,255,0.9), rgba(255,255,255,0.6)),url('../assets/iitbombay.jpg')`,backgroundSize:'cover'}}>
